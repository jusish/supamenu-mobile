    ...
    <ScrollView className="bg-white flex flex-1 rounded-t-xl py-4 px-6">
      <Pressable onPress={() => router.push("/(auth)/login")}>
        <Animated.View
          ...
          className="flex fixed flex-row justify-center py-4 items-center"
        >
          <Image
      ...
      <AuthHeader
        title="Welcome back,"
        description="Feel free to check out, our latest updates !"
      />
      <Animated.View
        key={"UniqueKey101"}
        ...
        >
          <View className="flex flex-1 flex-row justify-center place-items-center items-center ">
            <Image
              ...
              className="w-4 h-4"
            />
            <Text className="text-slate-700 font-medium ml-4">
